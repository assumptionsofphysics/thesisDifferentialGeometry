...
\begin{defn}
	$\Delta : F_k \to F_{k+1}$ such that $\Delta f_k(\sigma^{k+1}) = f_k(\partial \sigma^{k+1})$ is the \textbf{(border, edge, boundary, something like this?) derivative on k-functionals}. 
\end{defn}
...
\emph{Something was wrong with this definition, but I don't remember what}
\begin{defn}
