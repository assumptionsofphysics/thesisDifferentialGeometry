...
\begin{defn}
	$\Delta : F_k \to F_{k+1}$ such that $\Delta F(\sigma^{k+1}) = F(\partial\sigma^{k+1})$ is the \textbf{exterior derivative on k-functionals}. 
\end{defn}

TODO: Not "exterior derivative", choose a name that reminds one of it though
