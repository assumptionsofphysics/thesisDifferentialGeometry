...
In this way, we define the \textbf{exterior derivative $\eth$ on forms} as the tool which which we apply a k-form to the infinitesimal bits of the boundary of a (k+1)-surface. 
...
\begin{defn}
	...
	\begin{gather}\implies \eth f(\sigma) = \int_{\sigma} \eth\omega(d\sigma).\end{gather} 
\end{defn}
