...
\emph{Probably pretty good to clarify that B is a matrix; i.e. part of the electromagnetic field tensor. Specify that we're not talking about B as a pseudovector, as it doesn't generalize to more dimensions}
