...
\begin{prop}
	If k-functional $f \in F_k$ is exact, then there exists some functional $g \in F_{k-1}$ such that $f = \eth g$. 
\end{prop}

\textbf{We can still call $g$ here the potential for $f$, even though we're not in the infinitesimal case}
