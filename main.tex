...
The takeaway from this is the following: if we have a k-functional $f \in F_k$, then $\eth f \in F_k$ will necessarily be exact. And furthermore, if we have an exact functional $f \in F_k$, then $\eth f = 0$. 
