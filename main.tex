...
$F(\lambda) = \int_{\lambda}f(d\lambda) = \int_{v_0}^{v_1}\frac{\partial f}{\partial x^i}\frac{\partial x^i}{\partial v}dv
$


$\int\int\frac{\partial^2f}{\partial x^i\partial x^j}e^i\wedge e^j (\frac{\partial x^k}{\partial u}du e_k, \frac{\partial x^l}{\partial v}dv e_l)$



For vectors a and b, $ab := <a,b> + a\wedge b$

$X = \lambda + \vec{e} + \hat{b} + \bar{T}$
	
	
For 1-form $\omega_1$ and vector $\vec{v}$, $\omega_1(\vec{v}) = <\vec{e},\vec{v}>$ for some vector $\vec{e}$.

Likewise, for 2-form $\omega_2$ and vectors $\vec{v_1},\vec{v_2}$, $\omega_2(\vec{v_1},\vec{v_2}) = <\hat{b},\vec{v_1}\wedge\vec{v_2}>$ for some bivector $\hat{b}$.  


Hodge Operator $I := \vec{e_1}\vec{e_2}\vec{e_3}$

$\vec{e} = \frac{\vec{D}}{\sqrt{\epsilon}}$

$\hat{b} = \sqrt{\mu}\hat{H}$

$f := \vec{e} + \hat{b} = \vec{e} + I\vec{b}$


$D = \nabla + \sqrt{\epsilon \mu}\frac{\partial}{\partial t}$

$j = \frac{\rho}{\sqrt{\epsilon}} - \sqrt{\mu}\vec{j}$

$Df + \vec{e}Dln(\sqrt{\epsilon}) + \hat{b}Dln(\sqrt{\mu}) = j$
