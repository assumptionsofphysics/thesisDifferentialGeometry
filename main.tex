...
\textbf{Not coastline paradox, the limit is just the line. The coastline paradox is because of fractals}
...
\end{defn}
 ...
 [\textbf{If it remains motionless, the path is a point, no longer a path. What's important here is that the work done on an empty path or single point is going to be zero. Say prop 1.25 probably around here.}]
