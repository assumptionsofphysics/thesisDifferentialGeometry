...
\textbf{Clean up this derivation, it's not quite right}
...
\begin{defn}
	A \textbf{tensor} $X$ of rank [n k] is an object that transforms as $X'^{a...k}_{b...n} = \frac{\partial x'^a}{\partial x^d} ... \frac{\partial x'^k}{\partial x^j} \frac{\partial x^c}{\partial x'^b} ... \frac{\partial x^e}{\partial x'^n} X^{d...j}_{c...e}$. 
\end{defn}
...
\begin{defn}
	A tensor $T$ of rank [k n] $T: \Omega_k \times V^n \to \mathbb{R}$ is a multilinear map that k 1-forms and n 1-vectors to $\mathbb{R}$. 
\end{defn}
